...
export default function FSbox({
  ...
  const handleSortChange = (v: { by: string; dir: string }) => {
    ...
    if (
      String(currentBy) === String(v.by) &&
      String(currentDir) === String(v.dir)
    )
      return;
    ...
    <div className="fsbox">
      ...
      <div className="fsbox-row">
        <div className="fsbox-left">
          <div className="fsbox-search">
            <SearchBox />
          </div>
          <div className="fsbox-add">
            <AddBtn title={addTitle} onClick={() => setOpen(true)} />
          </div>
          <AddModalComponent
            isOpen={open}
        ...
        <div className="fsbox-right">
          <FillterOrder
            value={{
              ...
              dir:
                String(filters?.sort_dir ?? defaultSortDir) === "asc"
                  ? "asc"
                  : "desc",
            }}
